...
public class PythonConfigTest {
	...
	public void testPythonFilesInfo() {
		...
		pythonFiles.put("python_file_0", "file0.py");
	...
	public void testPythonRequirementsFileInfo() {
		Configuration config = new Configuration();
		config.set(PythonDependencyManager.PYTHON_REQUIREMENTS_FILE, "python_requirements_file_0");
		PythonConfig pythonConfig = new PythonConfig(config);
	...
	public void testPythonRequirementsCacheDirInfo() {
		Configuration config = new Configuration();
		config.set(PythonDependencyManager.PYTHON_REQUIREMENTS_CACHE, "python_requirements_cache_1");
		PythonConfig pythonConfig = new PythonConfig(config);
	...
	public void testPythonArchivesInfo() {
		...
		pythonArchives.put("python_archive_0", "file0.zip");
	...
	public void testPythonExec() {
		Configuration config = new Configuration();
		config.set(PythonDependencyManager.PYTHON_EXEC, "/usr/local/bin/python3");
		PythonConfig pythonConfig = new PythonConfig(config);
