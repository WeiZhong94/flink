...
public class PythonFunctionSqlTest {
	...
	public void prepareEnvironment() throws IOException {
		...
		try (OutputStream out = new FileOutputStream(new File(tmpdir, "test1.py"))) {
			String code = ""
		...
		flinkTableEnv.getConfig().getConfiguration().set(PythonOptions.PYTHON_CLIENT_PYTHONPATH, tmpdir);
		blinkTableEnv.getConfig().getConfiguration().set(PythonOptions.PYTHON_CLIENT_PYTHONPATH, tmpdir);
