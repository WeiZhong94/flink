...
import static org.apache.flink.client.python.PythonFunctionFactoryUtil.getExecutionEnvironmentConfiguration;
import static org.apache.flink.configuration.PythonOptions.PYTHON_CLIENT_EXECUTABLE;
...
public interface PythonFunctionFactory {
	...
	static PythonFunction getPythonFunction(String fullyQualifiedName, TableEnvironment environment)
		...
		Configuration combinedConf = new Configuration(getExecutionEnvironmentConfiguration(environment));
		Configuration appConf = environment.getConfig().getConfiguration();
		combinedConf.addAll(appConf);
