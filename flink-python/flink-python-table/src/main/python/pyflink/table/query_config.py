...
class StreamQueryConfig(QueryConfig):
    ...
    def with_idle_state_retention_time(self, min_time, max_time):
        ...
        :param min_time: The minimum time interval for which idle state is retained. Set to 0 (zero) to
                         never clean-up the state.
        :param max_time: The maximum time interval for which idle state is retained. Must be at least
