...
class PythonCollectionInputFormatTableSource[Row](
    ...
    dataType: RowTypeInfo
) extends InputFormatTableSource[Row] {

  private val tableSchema = new TableSchema(dataType.getFieldNames, dataType.getFieldTypes)

  override def getInputFormat: InputFormat[Row, _ <: InputSplit] = inputFormat

  override def getTableSchema: TableSchema = tableSchema

  override def getReturnType: TypeInformation[Row] = dataType.asInstanceOf[TypeInformation[Row]]
}
