...
public class LocalExecutor implements Executor {
	...
	public List<String> listTables(SessionContext session) throws SqlExecutionException {
		final AbstractTableEnvironment tableEnv = getOrCreateExecutionContext(session)
	...
	public String explainStatement(SessionContext session, String statement) throws SqlExecutionException {
		...
		final AbstractTableEnvironment tableEnv = context
			.createEnvironmentInstance()
			.getTableEnvironment();
	 ...
	 */
	private Table createTable(AbstractTableEnvironment tableEnv, String selectQuery) {
	 ...
	 */
	private <C> void applyUpdate(ExecutionContext<C> context, AbstractTableEnvironment tableEnv, QueryConfig queryConfig, String updateStatement) {
