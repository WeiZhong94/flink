...
import org.apache.flink.table.api.{AbstractTableEnvironment, ValidationException}
import org.apache.flink.table.factories.TableFactoryUtil

/**
  * Common class for table's created with [[AbstractTableEnvironment.connect(ConnectorDescriptor)]].
  */
abstract class ConnectTableDescriptor[D <: ConnectTableDescriptor[D]](
    private val tableEnv: AbstractTableEnvironment,
