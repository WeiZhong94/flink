...
/**
  ...
  */
  ...
  protected def unsupportedJavaMethod =
    new UnsupportedOperationException("This method is not supported in Scala environment!")

  override def registerFunction(name: String, tf: TableFunction[_]): Unit =
    throw unsupportedJavaMethod

  override def registerFunction(name: String, f: AggregateFunction[_, _]): Unit =
    throw unsupportedJavaMethod

  override def fromDataStream[T](dataStream: JavaDataStream[T]): Table =
    throw unsupportedJavaMethod

  override def fromDataStream[T](dataStream: JavaDataStream[T], fields: String): Table =
    throw unsupportedJavaMethod

  override def registerDataStream[T](name: String, dataStream: JavaDataStream[T]): Unit =
    throw unsupportedJavaMethod

  override def registerDataStream[T](
      name: String, dataStream: JavaDataStream[T], fields: String): Unit =
    throw unsupportedJavaMethod

  override def toAppendStream[T](table: Table, clazz: Class[T]): JavaDataStream[T] =
    throw unsupportedJavaMethod

  override def toAppendStream[T](table: Table, typeInfo: TypeInformation[T]): JavaDataStream[T] =
    throw unsupportedJavaMethod

  override def toAppendStream[T](
      table: Table, clazz: Class[T], queryConfig: StreamQueryConfig): JavaDataStream[T] =
    throw unsupportedJavaMethod

  override def toAppendStream[T](
      table: Table,
      typeInfo: TypeInformation[T],
      queryConfig: StreamQueryConfig): JavaDataStream[T] =
    throw unsupportedJavaMethod

  override def toRetractStream[T](
      table: Table, clazz: Class[T]): JavaDataStream[JTuple2[JBool, T]] =
    throw unsupportedJavaMethod

  override def toRetractStream[T](
      table: Table, typeInfo: TypeInformation[T]): JavaDataStream[JTuple2[JBool, T]] =
    throw unsupportedJavaMethod

  override def toRetractStream[T](
      table: Table,
      clazz: Class[T],
      queryConfig: StreamQueryConfig): JavaDataStream[JTuple2[JBool, T]] =
    throw unsupportedJavaMethod
