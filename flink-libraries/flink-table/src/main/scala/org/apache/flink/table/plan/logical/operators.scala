...
import org.apache.flink.table.api.{StreamTableEnvironment, AbstractTableEnvironment, Types, UnresolvedException}
...
case class Project(
  ...
  override def resolveExpressions(tableEnv: AbstractTableEnvironment): LogicalNode = {
  ...
  override def validate(tableEnv: AbstractTableEnvironment): LogicalNode = {
...
case class CatalogNode(
  ...
  override def validate(tableEnv: AbstractTableEnvironment): LogicalNode = this
}
