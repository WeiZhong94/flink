...
class BatchTableEnvironment(
  ...
  override def fromDataSet[T](dataSet: JavaDataSet[T]): Table = throw unsupportedJavaMethod

  override def fromDataSet[T](dataSet: JavaDataSet[T], fields: String): Table =
    throw unsupportedJavaMethod

  override def registerDataSet[T](name: String, dataSet: JavaDataSet[T]): Unit =
    throw unsupportedJavaMethod

  override def registerDataSet[T](name: String, dataSet: JavaDataSet[T], fields: String): Unit =
    throw unsupportedJavaMethod

  override def toDataSet[T](table: Table, clazz: Class[T]): JavaDataSet[T] =
    throw unsupportedJavaMethod

  override def toDataSet[T](table: Table, typeInfo: TypeInformation[T]): JavaDataSet[T] =
    throw unsupportedJavaMethod

  override def toDataSet[T](
      table: Table, clazz: Class[T], queryConfig: BatchQueryConfig): JavaDataSet[T] =
    throw unsupportedJavaMethod

  override def toDataSet[T](
      table: Table, typeInfo: TypeInformation[T], queryConfig: BatchQueryConfig): JavaDataSet[T] =
    throw unsupportedJavaMethod
