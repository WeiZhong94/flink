 ...
 * CountAggConverter
 */
public class CountAggConverter {
    public static RelBuilder.AggCall toAggCall(Count agg, boolean isDistinct, RelBuilder relBuilder) {
        ...
        return relBuilder.aggregateCall(
                ...
                null,
                agg.toString(),
                agg.child().accept(new ExpressionVisitorImpl(relBuilder)));
    }
    ...
    // TODO add toAggCall and getSqlAggFunction for every Aggregate.
