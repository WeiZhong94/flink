...
/**
 * Integration tests for {@link GeneralBatchTableEnvironment}.
 */
...
public class JavaTableEnvironmentITCase extends TableProgramsCollectionTestBase {
	...
	public void testRegisterTableFromOtherEnv() throws Exception {
		ExecutionEnvironment env = ExecutionEnvironment.getExecutionEnvironment();
		GeneralBatchTableEnvironment tableEnv1 = TableEnvironment.getTableEnvironment(env, config());
		GeneralBatchTableEnvironment tableEnv2 = TableEnvironment.getTableEnvironment(env, config());
