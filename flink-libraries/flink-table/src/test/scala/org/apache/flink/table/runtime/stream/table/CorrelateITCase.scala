...
import org.apache.flink.table.api.{GeneralStreamTableEnvironment, TableEnvironment, Types, ValidationException}
...
class CorrelateITCase extends AbstractTestBase {
  ...
  val tEnv: GeneralStreamTableEnvironment = TableEnvironment.getTableEnvironment(env)
